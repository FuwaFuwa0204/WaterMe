...
import com.example.waterme.ONE_M
import com.example.waterme.THREE_M
import com.example.waterme.TWO_M
...
fun ReminderDialogContent(
    ...
    val reminders = listOf(
        ...
        Reminder(R.string.one_m, ONE_M, TimeUnit.MINUTES, plantName),
        Reminder(R.string.two_m, TWO_M, TimeUnit.MINUTES, plantName),
        Reminder(R.string.three_m, THREE_M, TimeUnit.MINUTES, plantName)
    )
